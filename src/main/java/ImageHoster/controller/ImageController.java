...
public class ImageController {
    ...
    public String showImageId(@PathVariable("id") Integer id, Model model) {
    ...
    //This method is called when a non owner of an image tries to edit an image.
    @RequestMapping("/images/{id}/error")
    public String showImageIdError(@PathVariable("id") Integer id, Model model) {
        Image image = imageService.getImageById(id);
        model.addAttribute("image", image);
        model.addAttribute("tags", image.getTags());
    ...
    //This method is called when a non owner of an image tries to delete an image.
    @RequestMapping("/images/{id}/deleteerror")
    public String showImageIdDeleteError(@PathVariable("id") Integer id, Model model) {
        Image image = imageService.getImageById(id);
        model.addAttribute("image", image);
        model.addAttribute("tags", image.getTags());
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model,HttpSession session) {
        ...
        if(user.getId() != image.getUser().getId() ){
            return "redirect:images/"+image.getId()+"/error";
        }
        else {
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId,HttpSession session) {
        ...
        if(user.getId() != imageService.getImage(imageId).getUser().getId() ){
            return "redirect:images/"+ imageService.getImage(imageId).getId()+"/deleteerror";
        }else{
